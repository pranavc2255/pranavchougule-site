...
echo "==> Rebuilding from scratch in: $ROOT"
echo "==> Project: $PROJECT"

# ------------------------------------------------------------
# 0) Kill anything running on port 3000 (prevents "won't load")
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 1) Delete old project completely
# ------------------------------------------------------------
echo "==> Removing old project (if exists)..."
rm -rf "${PROJECT}"

# ------------------------------------------------------------
# 2) Create fresh Next.js app (stable + Tailwind)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 3) Force known-good Tailwind setup (PostCSS)
#    (Next sometimes generates variations; we standardize it)
# ------------------------------------------------------------
echo "==> Writing postcss.config.js (known-good)..."
...
echo "==> Writing src/app/globals.css (Tailwind directives)..."
...
# ------------------------------------------------------------
# 4) Tailwind theme colors (Blue/Saffron/Yellow/White)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 5) Create pages + components (multi-page + real horizontal tabs)
# ------------------------------------------------------------
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-border">
      ...
      {/* Mobile tabs (still horizontal, scrollable) */}
