  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="mb-16">
        ...
        <h1 className="font-serif text-5xl text-ink mb-4">Get in Touch</h1>
      ...
      <div className="grid md:grid-cols-2 gap-16">
        ...
        <div className="space-y-5">
          {channels.map((c) => (
            <a
              ...
              className="research-card flex items-start gap-5 border border-gray-100 bg-white p-6 block hover:border-navy/30 transition-colors"
            >
              <div className="w-10 h-10 bg-mist flex items-center justify-center shrink-0 font-serif text-lg text-navy">
                {c.icon}
              </div>
              <div>
                <p className="font-mono text-xs text-stone uppercase tracking-widest mb-1">{c.label}</p>
                <p className="font-serif text-lg text-navy mb-1">{c.value}</p>
                <p className="font-sans text-sm text-stone leading-relaxed">{c.desc}</p>
              </div>
            </a>
          ))}
        </div>
        ...
        {/* Right panel — context */}
        <div>
          <div className="bg-navy text-white p-8 mb-6">
            <h2 className="font-serif text-2xl mb-4">Research Collaboration</h2>
            <p className="font-sans text-sm text-blue-200 leading-relaxed mb-6">
          ...
          <div className="border border-gray-100 p-6">
            <p className="font-mono text-xs text-stone uppercase tracking-widest mb-3">Current Affiliation</p>
            <p className="font-serif text-xl text-navy mb-1">Drexel University</p>
            <p className="font-sans text-sm text-stone">Philadelphia, Pennsylvania, USA</p>
            <hr className="border-gray-100 my-4" />
            <p className="font-mono text-xs text-stone uppercase tracking-widest mb-3">Response Time</p>
