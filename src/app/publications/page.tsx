...
export const metadata: Metadata = {
  ...
  description: 'Publications and presentations by Pranav Chougule.'
}
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-20">
      ...
      <div className="mb-10 md:mb-16">
        ...
        <h1 className="font-serif text-ink mb-4">Publications</h1>
      ...
      <div className="mb-12 md:mb-20">
        <div className="flex flex-wrap items-center gap-3 mb-6 md:mb-8">
          <h2 className="font-serif text-navy">Conference Papers</h2>
        ...
        <div className="space-y-5 md:space-y-6">
          {publications.map((pub, i) => (
            <div key={i} className={`research-card border p-5 md:p-8 ${pub.highlight ? 'border-saffron/40 bg-[#fffdf7]' : 'border-gray-100 bg-white'}`}>
              ...
              <p className="font-sans text-sm text-stone mb-2 leading-relaxed">{pub.authors}</p>
              <h3 className="font-serif text-xl md:text-2xl text-navy mb-2 leading-snug">
                &ldquo;{pub.title}&rdquo;
              </h3>
              <p className="font-sans text-sm font-medium text-saffron-dark mb-4 md:mb-5">
                {pub.venue} · {pub.year}
              </p>
              {pub.abstract && (
                <div className="border-l-2 border-gray-200 pl-4 md:pl-5">
                  <p className="font-mono text-[10px] md:text-xs text-stone uppercase tracking-wider mb-2">Abstract</p>
      ...
      {/* Ongoing */}
      <div className="bg-mist border border-gray-100 p-6 md:p-8">
        <h3 className="font-serif text-xl md:text-2xl text-navy mb-3">Ongoing Research</h3>
